...
public class CRC16 {
	...
	public static final char TABLE1021[] = { /* CRC1021余式表 */
	...
	public static char getCRC16(byte b[], int len) {
	...
	// (byte) 0x34, (byte) 0x33, (byte) 0x47, (byte) 0x14,
	// (byte) 0x31, (byte) 0x34, (byte) 0x30, (byte) 0x36,
	// (byte) 0x00, (byte) 0x63, (byte) 0x62, (byte) 0x61,
	// (byte) 0xE2, (byte) 0x22, (byte) 0x00, (byte) 0x00,
	// (byte) 0x00};
	//
	// CRC16 crc = new CRC16();
	// int a = crc.getCRC1021(b, 10);
	// System.out.println("查表法:" + a);
	// String str = Integer.toHexString(a).toUpperCase();
	// System.out.println("十六进制:" + str);
	// System.out.println("计算法:" + crc.CRC_XModem(b));
	// System.out.println("十六进制:"
	// + Integer.toHexString(crc.CRC_XModem(b)).toUpperCase());
	// }
}