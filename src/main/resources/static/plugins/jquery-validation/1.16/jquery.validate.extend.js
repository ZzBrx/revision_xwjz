(function(a) {
	a("#inputForm .box-footer [class*=col-sm-offset]").append( '<div class="form-error">您填写的信息有误，请根据提示修正。</div>');
					...
					var c = function(g) {
						...
						case 18:
							if (parseInt(g.substr(6, 4)) % 4 == 0
									|| (parseInt(g.substr(6, 4)) % 100 == 0 && parseInt(g
											.substr(6, 4)) % 4 == 0)) {
							...
							if (ereg.test(g)) {
								f = (parseInt(d[0]) + parseInt(d[10])) * 7
										+ (parseInt(d[1]) + parseInt(d[11]))
										* 9
										+ (parseInt(d[2]) + parseInt(d[12]))
										* 10
										+ (parseInt(d[3]) + parseInt(d[13]))
										* 5
										+ (parseInt(d[4]) + parseInt(d[14]))
										* 8
										+ (parseInt(d[5]) + parseInt(d[15]))
										* 4
										+ (parseInt(d[6]) + parseInt(d[16]))
										* 2 + parseInt(d[7]) * 1
										+ parseInt(d[8]) * 6 + parseInt(d[9])
										* 3;
								j = f % 11;
								k = "F";
								e = "10X98765432";
